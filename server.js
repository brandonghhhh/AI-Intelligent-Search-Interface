...
IMPORTANT: Only recommend, mention, or discuss products from the following list. Do NOT mention, suggest, or refer to any products, brands, or companies that are not in this list, under any circumstances.
...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        const run = await openai.beta.threads.runs.create(threadId, {
            assistant_id: process.env.ASSISTANT_ID,
            instructions: `IMPORTANT: Only recommend, mention, or discuss products from the following list. Do NOT mention, suggest, or refer to any products, brands, or companies that are not in this list, under any circumstances.
